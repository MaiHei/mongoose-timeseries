...
var TimeSeriesSchema = function (args) {
    ...
    function getInitializer() {
        ...
        updates.statistics = _.clone(statisticsStruct);
        updates.hourly = new Array(24);
        for (let index = 0; index < updates.hourly.length; index++) {
            updates.hourly[index] = _.clone(statisticsStruct);
        }
